...
dotnet build $ProjectFile --configuration Release -p:GenerateAppxPackageOnBuild=true -p:Platform=ARM64 -p:SelfContained=true -p:RuntimeIdentifier=win-arm64 -p:AppxPackageDir="../AppPackages/ARM64/"
dotnet build $ProjectFile --configuration Release -p:GenerateAppxPackageOnBuild=true -p:Platform=x64 -p:SelfContained=true -p:RuntimeIdentifier=win-x64 -p:AppxPackageDir="../AppPackages/x64/"
